...
def run_up(
    ...
    *,
    ...
    if ic._is_mainnet() and not bindings.casals_backend_id and not conductor_override and not bootstrap:
        ...
        raise RuntimeError(
            f"no {env} bindings for {sheet_name} under {bindings_dir()}: this run would bootstrap a brand-new "
